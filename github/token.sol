...
contract SGRToken is ERC20, ERC20Detailed, Ownable{
    ...
    function init(address _RP, uint256 _walletAGate, uint256 _walletBGate, uint256 _fatherGate, uint256 _grandFatherGate, uint256 _brunGate, address _buyContract, address _airDrop, address _IDOConttact, uint256 _startSell, uint256 _startTransaction, uint256 _maxHoldAmount) public onlyOwner(){
        RP = relationship(_RP);
        ...
        maxHoldTokens = _maxHoldAmount * 10 ** uint256(decimals());
